...
> Replaced by [Memory & Context Intelligence](NEXUS-MEMORY-CONTEXT-INTELLIGENCE.md) for memory lifecycle, retrieval, and context, and [Knowledge & Information Ingestion](NEXUS_KNOWLEDGE_INFORMATION_INGESTION.md) for source-based knowledge formation.
